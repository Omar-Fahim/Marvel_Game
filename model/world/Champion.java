...
/*return "Champion name " + name + ", HP " + maxHP + ", Mana " + mana + ", Action points "
				+ maxActionPointsPerTurn + ", Attack range " + attackRange + ", Attack damage " + attackDamage
				+ ", Speed " + speed + ", Abilities " + abilities + "";*/
	@Override
	public String toString() {
		return " HP " + maxHP+ ", Mana " + mana + 
				", Action points "+ maxActionPointsPerTurn + ", Attack range " + attackRange + ", Attack damage " + attackDamage
				+ ", Speed " + speed +"\n"+ ", Abilities : " +"\n"+ "Ability 1"+"\n"+this.abilities.get(0).toString()
				+"\n"+ "Ability 2"+"\n"+this.abilities.get(1).toString()
				+"\n"+ "Ability 3"+"\n"+this.abilities.get(2).toString();
	}
